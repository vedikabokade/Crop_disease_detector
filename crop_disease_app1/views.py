...
#     global _model
#     if _model is None:
#         _model = load_model(os.path.join(settings.BASE_DIR, "model", "plant_disease_model.tflite"))
#     return _model
...
def get_model():
    ...
    if _interpreter is None:
        model_path = os.path.join(settings.BASE_DIR, "model", "plant_disease_model.tflite")
